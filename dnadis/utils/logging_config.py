#!/usr/bin/env python3
"""
Logging configuration for dnadis.
...
Usage:
    ...
    # Verbose logging
    ./dnadis.py --verbose [args]

    # Quiet mode with file logging
    ./dnadis.py --quiet --log-file analysis.log [args]
"""
...
def setup_logging(
    ...
    # Get root logger for dnadis
    root_logger = logging.getLogger("dnadis")
...
def get_logger(name: str) -> logging.Logger:
    ...
    """
    return logging.getLogger(f"dnadis.{name}")
