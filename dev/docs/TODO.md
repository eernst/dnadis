...
* [ ] In legends like Comparison Report -> Assembly overview -> Classification, the color tile should not be subject to line breaks independently of the associated label.

* [ ] Add the dnadis version number to the Generated by dnadis... record block at the end of the reports.
